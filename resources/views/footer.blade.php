        ...
        <div class="container">
            <div class="row">
                <div class="companyinfo">
                    <a href="index.html">
                        <img src="{{ asset('data/image/icnnsoft_logo.png') }}" alt="ICNNSOFT">
                    </a>
                </div>
...
<!--                    <li><a href="catalog-list.html">Catalog</a></li>
            ...
            <div class="f-menu">
                ...
                <ul class="nav nav-pills nav-stacked">
                    <li><a href="{{url ('cataloglist')}}">Desktop PC</a></li>
                    <li><a href="{{url ('cataloglistlp')}}">Laptop</a></li>
<!--                    <li><a href="catalog-list.html">Gaming</a></li>
                    <li><a href="catalog-list.html">Monitor</a></li>
...
<!--                    <li><a href="contacts.html">About us</a></li>
                    ...
                    <li><a href="{{ url('/contact') }}">Contacts</a></li>
                    <li><a href="{{ url('loginreg') }}">Log in</a></li>
                </ul>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="footer-copyright">
                    <i><a href="https://icnnsoft.com/">ICNNSOFT</a></i> © Copyright 2020
                </div>
            </div>
        </div>
    </div>
...
<script src="{{ asset('data/js/jquery-1.11.2.min.js') }}"></script>
<script src="{{ asset('data/js/jquery.bxslider.min.js') }}"></script>
<script src="{{ asset('data/js/fancybox/fancybox.js') }}"></script>
<script src="{{ asset('data/js/fancybox/helpers/jquery.fancybox-thumbs.js') }}"></script>
<script src="{{ asset('data/js/jquery.flexslider-min.js') }}"></script>
<script src="{{ asset('data/js/swiper.jquery.min.js') }}"></script>
<script src="{{ asset('data/js/jquery.waypoints.min.js') }}"></script>
<script src="{{ asset('data/js/progressbar.min.js') }}"></script>
<script src="{{ asset('data/js/ion.rangeSlider.min.js') }}"></script>
<script src="{{ asset('data/js/chosen.jquery.min.js') }}"></script>
<script src="{{ asset('data/js/jQuery.Brazzers-Carousel.js') }}"></script>
<script src="{{ asset('data/js/plugins.js') }}"></script>
<script src="{{ asset('data/js/main.js') }}"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhAYvx0GmLyN5hlf6Uv_e9pPvUT3YpozE"></script>
<script src="{{ asset('data/js/gmap.js') }}"></script>
