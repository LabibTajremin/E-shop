...
<main>
    <section class="container">
        ...
        <h1 class="main-ttl"><span>{{$item->Name}}</span></h1>
        ...
        <div class="prod-wrap" style="width:100%;">
                    ...
                    <ul class="prod-slider-car">
                        <li>
                            <a data-fancybox-group="product" class="fancy-img" href="http://placehold.it/500x642">
                                <img src="{{ asset("data/image/".$item->Image) }}" alt="">
                            </a>
                        </li>
                        <li>
            ...
            <div class="prod-cont">
                ...
                <div class="prod-info">
                    <p class="prod-price">
                        <b class="item_current_price">{{$item->Price}}</b>
                    </p>
                    <p class="prod-qnt">
            ...
            <div class="prod-tabs-wrap">
                <ul class="prod-tabs">
                    ...
                    <li><a data-prodtab-num="2" id="prod-props" href="#" data-prodtab="#prod-tab-2">Specification</a></li>
                ...
                <div class="prod-tab-cont">
                    ...
                    <p data-prodtab-num="2" class="prod-tab-mob" data-prodtab="#prod-tab-2">Specification</p>
